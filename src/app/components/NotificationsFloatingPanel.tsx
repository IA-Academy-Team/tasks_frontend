  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-20 right-8 z-[1250] inline-flex size-11 items-center justify-center rounded-xl border border-border bg-card text-foreground shadow-[var(--shadow-md)] transition-all hover:bg-secondary hover:scale-[1.02] mb-2"
      ...
      >
        <motion.span
          animate={isOpen ? { rotate: [0, -10, 8, -4, 0] } : { rotate: 0 }}
        ...
        {hasUnreadNotifications && (
          <motion.span
            className="absolute -right-1 -top-1 inline-flex min-w-5 items-center justify-center rounded-full bg-destructive px-1 text-[10px] font-semibold text-destructive-foreground"
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: [1, 1.12, 1], opacity: 1 }}
            transition={{ duration: 1.8, repeat: Number.POSITIVE_INFINITY, repeatType: "mirror" }}
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.section
            className="fixed bottom-[5.25rem] right-8 z-[1250] w-[22rem] rounded-2xl border border-border bg-card shadow-[var(--shadow-xl)]"
