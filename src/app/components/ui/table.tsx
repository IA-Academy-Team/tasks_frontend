...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-muted/70 border-t border-border/85 font-medium [&>tr]:last:border-b-0",
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/65 data-[state=selected]:bg-muted border-b border-border/85 transition-colors",
        className,
      )}
      {...props}
    />
